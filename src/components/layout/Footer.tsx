    ...
    return (
        <footer className="">
            <div className="container p-6 mx-auto relative overflow-y-hidden">
                ...
                />
                <img
                    className="w-[400px] h-[500px] -z-30 absolute -top-1/2 -right-0"
                    src="Plant.svg"
                    alt=""
                />
                    ...
                    <div className="mt-6 lg:mt-0 lg:flex-1">
                        <div className="grid grid-cols-2 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            <div>
                                ...
                                >
                                    About Disaster Community Health
                                </a>
                                <a
                                    href="/community"
                                    className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"
                            ...
                            <div>
                                ...
                                <a
                                    href="/products/aperion-ui"
                                    className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"
                                >
                                    Emergency Kits
                                </a>
                                <a
                                    href="/products/meraki-ui"
                                    className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"
                                >
                ...
                <div>
                    <p className="text-center text-gray-500 dark:text-gray-400">
                        © Donation {new Date().getFullYear()} - All rights reserved
                    </p>
                </div>
            </div>
        </footer>
